...
//				System.out.println("rowData size= " + rowData.length);
	...
	public static void main(String args[]) throws Exception {
		...
		File filepath = new File(System.getProperty("user.dir")+"\\Inputs\\config.properties");
		File filepath1 = new File(System.getProperty("user.dir")+"\\Inputss");
		System.out.println("***** "+filepath1.exists());
		System.out.println(System.getProperty("user.dir")+"\\Inputs\\config.properties : "+filepath.exists());
